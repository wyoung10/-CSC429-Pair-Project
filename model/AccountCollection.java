...
public class AccountCollection  extends EntityBase implements IView
{
		...
		Exception
	{
		...
		/*This ultimately builds a collection of accounts based on the ownerID. 
		Consider a situation where an owner has multiple accounts, then this would
		build a collection of all those accounts
		*/
