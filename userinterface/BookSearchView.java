 ...
 public class BookSearchView extends View{
     ...
     */
     ...
     public BookSearchView(IModel librarian){
        ...
        myModel.subscribe("searchBookMessage", this);
    ...
    private Node createTitle(){
        ...
        Text titleText = new Text(" SEARCH BOOK ");
    ...
    public void processSubAction(Event evt){
        ...
        if (searchField == null){
            ...
            //and search
            myModel.stateChangeRequest("searchBook", searchString);
	...
	{
		searchField.setText((String)myModel.getState("SearchBook"));
	}
